...
while(l!='c'):
    g=(a+b)//2
    print("Is your secret number "+str(g)+"?\nEnter 'h' to indicate the guess is too high. Enter 'l' to indicate the guess is too low. Enter 'c' to indicate I guessed correctly.",end='')
    l=input()
    if(l not in 'chl'):print("Sorry, I did not understand your input.")
    else:
        if(l=='c'):
